...
export const groupTextItemsIntoLines = (textItems: TextItems): Lines => {
    ...
    // This creates many noises, where a single text item is divided into multiple ones. This step is to merge adjacent text items if their distance is smaller than a typical char width to filter out those noises.
