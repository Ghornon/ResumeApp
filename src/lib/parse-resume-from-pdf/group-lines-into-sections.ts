...
const isSectionTitle = (line: Line, lineNumber: number) => {
    ...
    // The main heuristic to determine a section title is to check if the text is double emphasized to be both bold and all uppercase, which is generally true for a well formatted resume
